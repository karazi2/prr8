...
class ItemNote extends StatefulWidget {
  final Note note;
  final Function(Note) onAddToCart; // Функция добавления в корзину
  final List<Note> cartItems; // Список товаров в корзине
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              onPressed: () {
                widget.onAddToCart(widget.note); // Добавление в корзину
